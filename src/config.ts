...
/** The clip length available without an account. Signed-in users get the
 *  selected model's `maxSeconds` instead; Mirelo repeats this boundary on the
 *  server before it opens a billed upload slot. */
